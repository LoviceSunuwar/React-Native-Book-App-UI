...
import { Alert, Button, ActivityIndicator, View, StyleSheet , ScrollView, TextInput, Text, Image} from 'react-native';
...
class DetailsComponent extends Component {
  constructor() {
    super();
    this.cartref = firebase.firestore().collection('carts');
    this.state = {
      book_name: '',
      author_name: '',
      publi_name:'',
  ...
  addCartBook() {
    ...
    //   isLoading: true,
    // });
    // const docUpdate = firebase.firestore().collection('carts').doc(this.state.key);
    // docUpdate.add({
  ...
  alertDialog=()=>{
    Alert.alert(
      ...
      'NO',
      [
        {text: 'Yes', onPress: () => console.log('Item Added')},
